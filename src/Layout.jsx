...
const navItems = [
  { label: 'Collections', page: 'Dashboard', icon: LayoutGrid },
  { label: 'Catalog', page: 'Catalog', icon: BookOpen },
  { label: 'Price Guide', page: 'PriceGuide', icon: TrendingUp },
  { label: 'Analytics', page: 'Analytics', icon: BarChart3 },
  { label: 'Profile', page: 'Settings', icon: User },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            {navItems.map(({ label, page, icon: Icon }) => {
              ...
              return (
                <Link key={page} to={createPageUrl(page)} className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all ${active ? 'text-[#e8c97a] bg-[#c9a84c]/10' : 'text-[#f5f0e8]/60 hover:text-[#f5f0e8] hover:bg-white/5'}`}>
