...
// Legacy sync version for quick checks (reads cached value)
let _cachedHasKey = null;
export const hasApiKeySync = () => _cachedHasKey;
export const refreshApiKeyStatus = async () => {
  _cachedHasKey = await hasApiKey();
