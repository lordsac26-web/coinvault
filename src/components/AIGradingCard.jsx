    ...
    <div className="rounded-2xl border border-[#c9a84c]/20 overflow-hidden" style={{ background: 'rgba(17,24,39,0.8)', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xl font-bold text-[#e8c97a]" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>{grading.suggested_grade}</span>
      ...
      {expanded && (
        <div className="p-4 space-y-4">
          ...
          <p className="text-xs text-[#f5f0e8]/30 italic">AI grading is for reference only. Professional grading services provide certified, guaranteed grades.</p>
        </div>
      )}
    </div>
  );
